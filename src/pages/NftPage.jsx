  ...
  return (
    <>
      <Nft
        ...
        deleteNft={deletingModalToggle}
        toggleEditOpen={toggleEditOpen}
        submitUpdateNft={submitUpdateNft}
        edit={edit}
        show={show}
      />
      {deleting &&
        createPortal(
          <ConfirmModal
            text={`Delete NFT "${nftDetails.nft.title}"?`}
            confirm={deleteNft}
            cancel={deletingModalToggle}
            show={show}
          />,
      ...
      {edit &&
        createPortal(
          <NftModal
            onSubmit={submitUpdateNft}
            type="edit"
            toggleModal={toggleEditOpen}
            initialState={nftDetails.nft}
            show={show}
            modalOpen={edit}
            sumbitText="Confirm edit"
          />,
          document.querySelector('#modal-root')
        )}
    </>
