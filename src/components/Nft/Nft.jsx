      ...
      <NftContainer>
        ...
        <PaddingWrapper>
          <InfoContainer>
            ...
            <DetailsList>
              <DetailsListItem>
                <DetailsLink href={details.etherscan}>
                  <LinkIcon as={Globe} />
                  View on Etherscan
                </DetailsLink>
              </DetailsListItem>
              <DetailsListItem>
                <DetailsLink href={details.original}>
                  <LinkIcon as={Globe} />
                  View Original
                </DetailsLink>
              </DetailsListItem>
            ...
            <TagsList>
              {tagsToRender.map(tag => (
                <TagsListItem key={tag}>{tag.toUpperCase()}</TagsListItem>
              ))}
            </TagsList>
          </InfoContainer>
        </PaddingWrapper>
      ...
      <MoreContainer>
        <PaddingWrapper>
          <MoreTopWrapper>
            ...
            {!isMobile && user._id !== author._id && (
              <ToArtistLink to={`/profile/${author._id}`}>
                <Button
                  type="button"
                  iconType="arrowr"
                  fill="accent"
          ...
          <NftsList
            nfts={
              isMobile
                ? nftDetails.moreFromAuthor.slice(0, 2)
                : isTablet
                ? nftDetails.moreFromAuthor.slice(0, 4)
                : nftDetails.moreFromAuthor.slice(0, 6)
            }
          />
          {isMobile && user._id !== author._id && (
            <LinkWrapper>
